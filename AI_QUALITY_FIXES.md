...
> Создан по итогам e2e тестов 03-09. Обновлён 15.09.2026 после деплоя исправлений. **35/35 тестов ✅**

## Статус исправлений
| # | Проблема | Статус | Коммит |
|---|----------|--------|--------|
| 1 | Смешение языков в БД (`locations.description`) | ✅ БД чистая (проблемы не было) | — |
| 2 | `<narrative text>` placeholder | ✅ Исправлено | `fe0f1c9` |
| 3 | Атака → `drop` (`бросаюсь` матчился drop regex) | ✅ Исправлено | `fe0f1c9` |
| 4 | Атака → компаньон вместо врага (`npcs[0]`) | ✅ Исправлено | `f865226` |
| 5 | Английские слова в нарративе (`knot`, `intending`) | ✅ Исправлено | `f865226` |
| 6 | `наношу удар` → transfer (regex miss "нанос" vs "нанош") | ✅ Исправлено | `f865226` |
| 7 | `государство` матчило `дар` → transfer | ✅ Исправлено | `ac4e20c` |
| 8 | `спрашиваю` не попадало в talk regex | ✅ Исправлено | `ac4e20c` |
| 9 | Предмет не найден при `transfer` | ✅ Улучшено | `fe0f1c9` |
| 10 | NPC не найден при `talk` (цель по имени не резолвится) | ✅ Исправлено (4 уровня) | `53c7db8` |
| 11 | Повторяющееся вступление в нарративе | ✅ Инструкция добавлена | `fe0f1c9` |
| 12 | Опечатка "роши" → "рощи" — AI-галлюцинация | ⚠️ Runtime (не DB) | — |
| 13 | **АРХИТЕКТУРА**: Заменён regex на AI-классификатор (deepseek-v3) | ✅ Внедрено | `488a12a` |
| 14 | **DB**: Дубликаты локаций (×8) засоряли lore-контекст | ✅ Исправлено (75 уник.) | SQL |
