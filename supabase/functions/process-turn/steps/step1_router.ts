...
13. **Взаимодействие с другими игроками (PvP, разговор, помощь)**:
   - В сессии участвуют другие живые игроки! Список доступен в блоке "## Другие игроки рядом".
   - Если действие направлено на другого игрока, ОБЯЗАТЕЛЬНО используй его UUID из списка "Другие игроки рядом" как target_entity_id:
     * Разговор / обращение к сопартийцу ("Говорю с Элианом", "Спрашиваю у Бориса: куда идём?"):
       action_type: "talk", target_entity_id: UUID игрока, stat_to_check: "none".
     * Атака на игрока (PvP) ("Атакую Элиана", "Бью напарника"):
       action_type: "attack", target_entity_id: UUID игрока.
     * Передача предмета или золота игроку:
