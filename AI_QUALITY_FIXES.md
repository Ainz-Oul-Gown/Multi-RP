...
|---|----------|--------|--------|
| 1 | Смешение языков в БД (`locations.description`) | ⏳ DB fix needed | — |
...
| 10 | NPC не найден при `talk` | ⏳ Pending | — |
| 11 | Повторяющееся вступление | ✅ Инструкция добавлена | `fe0f1c9` |
| 12 | Опечатка "роши" → "рощи" | ⏳ DB fix needed | — |
