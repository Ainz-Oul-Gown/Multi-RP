...
| 4 | **НОВЫЙ**: Атака → компаньон вместо врага (`npcs[0]`) | ✅ Исправлено | `f865226` |
...
| 7 | Предмет не найден при `transfer` | ✅ Улучшено | `fe0f1c9` |
| 8 | NPC не найден при `talk` | ⏳ Pending | — |
| 9 | Повторяющееся вступление | ✅ Инструкция добавлена | `fe0f1c9` |
| 10 | Опечатка "роши" → "рощи" | ⏳ DB fix needed | — |
