...
9. СОВМЕСТНЫЙ ОТРЯД (Многопользовательская партия):
   - Все игроки из \`player_truths\` — это соратники в одном отряде, путешествующие вместе плечом к плечу в одной локации!
   - Если один герой совершает действие (разговаривает с торговцем, осматривает руины, вступает в бой, добывает ресурсы) — его напарник видит это своими глазами прямо перед собой.
   - Обязательно упоминай напарников по имени в тексте друг друга (например: "Вы наблюдаете, как [Имя] решительно шагает вперёд...", "Рядом с вами [Имя] выхватывает оружие...").
