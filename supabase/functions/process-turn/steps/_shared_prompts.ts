...
- Если игрок находится внутри здания, таверны или подземелья и выходит наружу/на улицу/на тракт ("выхожу из таверны", "выхожу на улицу", "покидаю таверну", "иду наружу"):
  * location_changed = true
  * Если в списке есть подходящая локация снаружи — выбери её (new_location_id, is_wild_zone = false)
  * Если в списке других локаций нет — выходи на прилегающую территорию: is_wild_zone = true, new_location_name = "Придорожный тракт у " + текущее название (или "Окрестности таверны")
